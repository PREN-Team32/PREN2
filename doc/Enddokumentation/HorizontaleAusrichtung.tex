\section{Horizontale Ausrichtung}
    ...
    \label{sec:StepperAnsteuerung}
        ...
        siehe Anhang \ref{apx:StepperDoku}. Dieses Board kann direkt auf das Freedom-Board aufgesteckt 
        und über die Konsole bedient werden. Die Hardware aus der ET-Gruppe wurde dahingehend angepasst, 
        dass ein Stecker mit der entsprechenden Pinbelegung für die beiden Brushlessboards und das 
        PWM-Signal für den DC-Motor angebracht wurde. Die gesamte Dokumentation dazu ist im Anhang 
