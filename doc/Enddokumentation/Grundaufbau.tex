\section{Grundaufbau}
	...
	\subsection{Herstellung Acrylglas}
		...
		noch je $1\si{\milli\meter}$ beträgt und das Acrylglas sehr schnell weich wird. Ebenfalls musste die Schnittgeschwindigkeit für das Bohren drastisch gesenkt 
		werden gegenüber einem normalen Kunststoff wie PE. Die seitlichen Bohrungen an 
		den Seitenwänden wurden auf einer Universalfräsmaschine gefertigt, die über eine horizontale Frässpindel verfügt (siehe Abbildungen). Die Bohrungen für die 
		...
		\begin{figure}[h!]
			\begin{minipage}[hbt]{0.5\textwidth}
		   		...
		   		{Enddokumentation/Bilder/Dummy.jpg} 
		   		\caption{Modell mit einer hohen Last}
		   		\label{fig:SimulationStromquelle1}
			\end{minipage}
			\hfill
			\begin{minipage}[hbt]{0.5\textwidth}
		   		\centering
		   		\includegraphics[width=1\textwidth,clip,trim= 0mm 0mm 0mm 0mm]
		   		{Enddokumentation/Bilder/Dummy.jpg} 
		   		\caption{Modell mit keiner Last}
		   		\label{fig:SimulationStromquelle2}
			\end{minipage}
		\end{figure}
