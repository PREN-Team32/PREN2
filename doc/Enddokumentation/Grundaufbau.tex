\section{Grundaufbau}
    ...
    \subsection{Hauptcontroller}
        ...
        verfügt über zwei SPI\footnote{Serial Peripheral Interface, ein synchronen seriellen Datenbus }-Schnittstellen. An einer ist das besagte Stepperboard und 
        an der anderen die beiden Brushless-Boards angeschlossen. Weiter wird ein PWM-Port 
